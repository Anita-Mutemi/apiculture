...
function ready() {
  ...
  // Buy Button to alert after your making order
...
// Clear the Cart when an order has been placed.
...
function updatetotal() {
  ...
  for (var i = 0; i < cartBoxes.length; i++) {
    ...
    var itemTotalElement = cartBox.getElementsByClassName("item-total")[0];
    itemTotalElement.innerText = "Ksh" + itemTotal.toFixed(2);
  }
